...
[Bootstrapping the Kubernetes Control Plane](08-bootstrapping-kubernetes-controllers.md)&emsp;&emsp;[Configuring kubectl for Remote Access](10-configuring-kubectl.md)&emsp;&emsp;
